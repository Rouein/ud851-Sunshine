...
//  Done (18) Create a String array containing the names of the desired data columns from our ContentProvider
    public static final String[] DESIRED_DATA_COLUMNS = {
...
//      Done (13) Find each of the TextViews by ID
        ...
        mHighView = (TextView) findViewById(R.id.high_temperature);
        mLowView = (TextView) findViewById(R.id.low_temperature);
...
//      Done (26) Display a readable data string
        ...
        String dataText = SunshineDateUtils.getFriendlyDateString(this, localDate, true);
...
//      Done (27) Display the weather description (using SunshineWeatherUtils)
        ...
        String description = SunshineWeatherUtils.getStringForWeatherCondition(this, conditionId);
        mDescriptionView.setText(description);
//      Done (28) Display the high temperature
        double maxTempC = data.getDouble(INDEX_WEATHER_MAX_TEMP);
        String maxString = SunshineWeatherUtils.formatTemperature(this, maxTempC);
        mHighView.setText(maxString);
//      Done (29) Display the low temperature
        double minTempC = data.getDouble(INDEX_WEATHER_MIN_TEMP);
        String minString = SunshineWeatherUtils.formatTemperature(this, minTempC);
        mLowView.setText(minString);
...
//      Done (33) Store a forecast summary in mForecastSummary
        mForecastSummary = String.format("%s - %s - %s/%s",
                dataText, description, maxString, minString);
    }
