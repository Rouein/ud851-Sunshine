    ...
    //  Done (5) Check to see if our weather ContentProvider is empty
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                String[] projrction = {WeatherContract.WeatherEntry._ID};
                Cursor cursor = context.getContentResolver().query(uri, projrction, WeatherContract.WeatherEntry.getSqlSelectForTodayOnwards(),null,null);
